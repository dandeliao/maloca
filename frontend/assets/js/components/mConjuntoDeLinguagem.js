class MConjuntoDeLinguagem extends HTMLElement {
    constructor() {
        super();
        ...
        .then(data => {
                let cdl = "";
                Object.values(data.conjuntoDeLinguagem).forEach(val => {
                    cdl = cdl + "(";
                    val.forEach(i => {
                        cdl = cdl + i + ", ";
                    })
...
window.customElements.define('m-conjunto-de-linguagem', MConjuntoDeLinguagem);