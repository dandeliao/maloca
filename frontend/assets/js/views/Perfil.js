...
export default class extends AbstractView {
    ...
    async getHtml() {
        return `
            <m-container style="--background-image: url('https://upload.wikimedia.org/wikipedia/commons/f/f3/Lingua_Libre_background_tile.png')">
                <h1>Olá, sou eu a xu!</h1>
                <p>
                ...
                <m-card>
                    <h1>Cartãozim</h1>
                    <br>
                    <p>Alo alo marciano</p>
                    <br>
                    <p>Poop on the floor, break a planter, sprint, eat own hair, vomit hair, hiss, chirp at birds, eat a squirrel, hide from fireworks, lick toe beans, attack christmas tree.</p>
                </m-card>
                <m-card>
                    <h1>Descrição</h1>
                    <marquee>
